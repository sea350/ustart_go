...
func ChangeEventLocation(eclient *elastic.Client, eventID string, Sdate time.Time, Edate time.Time, country string, state string, city string, street string, zip string) error {
