...
func main() {
	...
	*/
	...
	http.HandleFunc("/LoadProjectJoinRequests/", event.LoadProjectGuestJoinRequests)
	...
	http.HandleFunc("/ProjectRequestToJoin/", event.ProjectGuestRequestToJoin)
	...
	http.HandleFunc("/RejectProjectJoinRequest/", event.RejectProjectEventGuestJoinRequest)
