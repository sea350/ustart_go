...
//PrototypeEventSearch ... Attempt at fully functional event search, returns Floatinghead
/* Inputs:
eclient		-> ???
...
*/
func PrototypeEventSearch(eclient *elastic.Client, searchTerm string, sortBy int, searchBy []bool, mustMajor []string, mustTag []string, mustLoc []types.LocStruct) ([]types.FloatingHead, error) {
