			...
			if jEntries[i].Element.Classification == 0 {
				...
				class0 += `<div id="wallPosts" class="panel-body">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <ul>
                                                    <li>
                                                         <a class="btn btn-sm like-btn" id =main-modal` + jEntries[i].ElementID + `><img class="like-btn-ico" src="/ustart_front/ico/like.png">  <p class="mt-0" style="color:cadetblue; display:inline;">` + likes + `</p></a>
                                                    </li>
                                                    <li>
                                                         <a class="btn btn-sm comment-btn" id =main-modal` + jEntries[i].ElementID + `><img class="coment-btn-ico" src="/ustart_front/ico/no comment.png">  <p class="mt-0" style="color:cadetblue; margin-left:1px; display:inline;">` + string(jEntries[i].NumReplies) + `</p></a>
                                                    </li>
                                                    <li>
                                                         <a class="btn btn-sm share-btn" id=share-modal` + jEntries[i].ElementID + `><span><img class="share-btn-ico" src="/ustart_front/ico/not share.png"> <p class="mt-0" style="margin-left:1px; color:cadetblue; display:inline;">` + string(jEntries[i].NumShares) + `</p></span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <!-- end regular post -->
						 ...
						 <div class="dropdown pull-right">
                                        ...
                                        <div class="media">
                                            <div class="panel panel-default">
                                                ...
                                                <ul>
                                                    <li>
                                                         <a class="btn btn-sm like-btn" id =main-modal` + jEntry[0].ElementID + `><img class="like-btn-ico" src="/ustart_front/ico/like.png">  <p class="mt-0" style="color:cadetblue; display:inline;">` + string(jEntry[0].NumLikes) + `</p></a>
                                                    </li>
                                                    <li>
                                                         <a class="btn btn-sm comment-btn" id =main-modal` + jEntry[0].ElementID + `><img class="coment-btn-ico" src="/ustart_front/ico/no comment.png">  <p class="mt-0" style="color:cadetblue; margin-left:1px; display:inline;">` + string(jEntry[0].NumReplies) + `</p></a>
                                                    </li>
                                                    <li>
                                                         <a class="btn btn-sm share-btn" id=share-modal` + jEntry[0].ElementID + `><span><img class="share-btn-ico" src="/ustart_front/ico/not share.png"> <p class="mt-0" style="margin-left:1px; color:cadetblue; display:inline;">` + string(jEntry[0].NumShares) + `</p></span></a>
                                                    </li>
                                                </ul>
                                        </div>
`
