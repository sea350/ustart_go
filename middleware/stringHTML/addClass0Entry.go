...
func AddClass0Entry(image string, fName string, content string, elementID string, numLikes string, numReplies string, numShares string) string {
	return `
	<div id="wallPosts" class="panel-body">
		<!-- regular post sample -->
		<div class="media">
			...
			<ul>
				<li>
					<a class="btn btn-sm like-btn" id =main-modal` + elementID + `>
						<img class="like-btn-ico" src="/www/ustart.tech/ico/like.png"> 
						<p class="mt-0" style="color:cadetblue; display:inline;">` + numLikes + `</p>
					</a>
				</li>
				<li>
					<a class="btn btn-sm comment-btn" id =main-modal` + elementID + `>
						<img class="coment-btn-ico" src="/www/ustart.tech/ico/no comment.png">
				...
				<li>
					<a class="btn btn-sm share-btn" id=share-modal` + elementID + `>
					 	<span>
							<img class="share-btn-ico" src="/www/ustart.tech/ico/not share.png">
